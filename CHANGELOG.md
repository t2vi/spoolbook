...
| Version | Date | Notes |
|---|---|---|
| [v0.1.7](docs/releases/v0.1.7.md) | 2026-08-14 | Recommend page retired (suggestion now inline in print flow); printer controls gate on live print state; SvelteKit frontend migration in progress |
